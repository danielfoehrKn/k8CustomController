...
type DatabaseInterface interface {
	...
	GetScale(databaseName string, options metav1.GetOptions) (*autoscalingv1.Scale, error)
	UpdateScale(databaseName string, scale *autoscalingv1.Scale) (*autoscalingv1.Scale, error)
...
func newDatabases(c *DanielfoehrknV1Client, namespace string) *databases {
	return &databases{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
// GetScale takes name of the database, and returns the corresponding autoscalingv1.Scale object, and an error if there is any.
func (c *databases) GetScale(databaseName string, options metav1.GetOptions) (result *autoscalingv1.Scale, err error) {
...
func (c *databases) UpdateScale(databaseName string, scale *autoscalingv1.Scale) (result *autoscalingv1.Scale, err error) {
	result = &autoscalingv1.Scale{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("databases").
